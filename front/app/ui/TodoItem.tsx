...
export default function TodoItem(props: TodoItemProps) {
  ...
  function ChangeTaskState() {
    axios
      .patch(`http://ec2-3-76-208-35.eu-central-1.compute.amazonaws.com:8000/tasks/${props.id}/update/`, { is_done: !taskIsDone })
      .then(() => {
  ...
  function EditTask(title: string, priority: number) {
    axios
      .patch(`http://ec2-3-76-208-35.eu-central-1.compute.amazonaws.com:8000/tasks/${props.id}/update/`, {
        title: title,
        priority: priority,
      })
